      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-white dark:bg-gray-900">
        <div className="flex flex-col items-center gap-4">
          <div
            ...
            aria-label="Loading"
          />
          <p className="text-lg text-gray-600 dark:text-gray-400">Loading boards...</p>
        </div>
      </main>
    );
  }
      ...
      <div className="max-w-4xl w-full">
        ...
        {boardsError && (
          <div className="mb-8 p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
            <p className="text-red-700 dark:text-red-400">{boardsError}</p>
          </div>
        )}
          ...
          <div className="mt-8 space-y-6">
            ...
            {metricsError && (
              <div className="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                <p className="text-red-700 dark:text-red-400">{metricsError}</p>
              </div>
            )}
